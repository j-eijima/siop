...
| [0015](docs/decisions/0015-rp-accepts-one-response-per-request.md) | The test RP accepts one response per request; each result page judges once, and redraws never claim | Touching `rp/public/pending.js`, `callback.js`, how the request page records a request, or anything about replay |
